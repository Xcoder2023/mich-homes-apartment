...
//  pop up assets
import flat1 from "../../assets/pop-up-assets/Rectangle 28.png";
...
const Act2 = () => {
  ...
  return (
    <>
        ...
        <div className="rooms-show">
          <div className="room1">
            <div className="navigation-arrows">
              <div className="left-arrow" onClick={popUp}>
                <svg
              ...
              <div className="right-arrow" onClick={popUp}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
                  height="48"
      ...
      {/* pop up page */}
  {open &&(
      <div className="swipe-content active">
        <div className="close">
